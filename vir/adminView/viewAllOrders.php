<div id="ordersBtn" >
  ...
  <table class="table table-striped">
    <thead>
      <tr>
        <th  style="background-color: #4c99c9;">ID</th>
        <th  style="background-color: #4c99c9;">Customer</th>
        <th  style="background-color: #4c99c9;">Card_number</th>
        <th  style="background-color: #4c99c9;">expirity_date</th>
        <th  style="background-color: #4c99c9;">CVV</th>
        <th  style="background-color: #4c99c9;">pay_status</th>
        <th  style="background-color: #4c99c9;">order_status</th>
        <th  style="background-color: #4c99c9;">details</th>
     </tr>
    </thead>
     <?php
